...
public class upload extends AppCompatActivity {
    ...
    private final int SELECT_PICTURE = 1; String idCurrentUser; //membuat variable dr view
    StorageReference store; Uri imageUri; DatabaseReference dataref; //membuat variable dr view
    ImageView gambardiupload; EditText title; EditText caption; //membuat variable dr view
    ProgressDialog dlg;
    @Override
