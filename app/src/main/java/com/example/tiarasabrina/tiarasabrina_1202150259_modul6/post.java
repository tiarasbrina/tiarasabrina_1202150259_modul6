...
public class post extends AppCompatActivity {
    ...
    TextView user, title, caption;//membuat variable dr view
    ImageView image; EditText sourcekomentar;//membuat variable dr view
    RecyclerView rc; AdapterComment adapter; ArrayList<DBcomment> list; //membuat variable dr view
    DatabaseReference dref; ProgressDialog pd; //membuat variable dr view
    String usernya, idfoto; //membuat variable dr view
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mendapatkan intent dan menyimpannya ke variable
